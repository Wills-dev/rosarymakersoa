...
const HeroSection = () => {
  return (
    <section className="w-full h-screen container mx-auto p-4 pt-24">
      <div className="max-w-3xl h-full flex flex-col gap-8 justify-center">
        <h1 className="sm:text-6xl text-3xl font-extrabold text-[#002d5b] leading-normal">
